...
\label{sec:bakgrund}
This subject is relevant to study as mistakes in the use of cashier systems can lead to economic loss and loss in customer confidence. Related to this, shrinkage is a term used to describe a loss of inventory, and in the case of retail it usually occurs in the Point Of Sale (POS), in other words the time and place the transaction occurs. Any kind of manipulation of the cashier system, either intentionally or by mistake, is called an POS Exception....
